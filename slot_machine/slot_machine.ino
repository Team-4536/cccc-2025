...
int motor_1_pins[4] = {2, 3, 4, 5}; // motor 1 pins
int motor_2_pins[4] = {6, 7, 8, 9}; // motor 2 pins
int motor_3_pins[4] = {10, 11, 12, 13}; // motor 3 pins
...
void setup() {
  ...
  begin_motors(motor_1_pins,motor_2_pins,motor_3_pins);              // motors
